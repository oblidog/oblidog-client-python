...
from ...models.ledger_update import LedgerUpdate
...
) -> HTTPValidationError | LedgerPublic | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | LedgerPublic]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | LedgerPublic
    """
