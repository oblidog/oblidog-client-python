...
T = TypeVar("T", bound="IntegrationCredentialPublic")


@_attrs_define
class IntegrationCredentialPublic:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        integration_credential_public = cls(
            created_at=created_at,
            expires_at=expires_at,
            id=id,
            key_prefix=key_prefix,
        ...
        integration_credential_public.additional_properties = d
        return integration_credential_public
